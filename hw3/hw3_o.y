...
function:       FUNCTION id '(' arguments ')' returnType statements_r fd
                ;


procedure:      PROCEDURE id '(' arguments ')' statements fd
                ;
...
condition_r: IF expression THEN statements_r END IF %prec LOWER_THAN_ELSE
        | IF expression THEN statements_r ELSE statements_r END IF
        ;
